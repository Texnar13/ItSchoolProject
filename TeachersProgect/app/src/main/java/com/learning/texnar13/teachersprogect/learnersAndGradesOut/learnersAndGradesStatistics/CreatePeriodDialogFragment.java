...
public class CreatePeriodDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // layout диалога
        View dialogLayout = getActivity().getLayoutInflater().inflate(R.layout.dialog_fragment_layout_create_period, null);
        builder.setView(dialogLayout);


// -- текстовое поле названия --
        final EditText editName = (EditText) dialogLayout.findViewById(R.id.create_period_dialog_fragment_edit_name);
...
// --- выбор даты ---
        ...
        // выводим дату
        editStartDay.setText("" + nowCalendar.get(GregorianCalendar.DAY_OF_MONTH));
        editStartMonth.setText("" + (nowCalendar.get(GregorianCalendar.MONTH) + 1));
        editStartYear.setText("" + nowCalendar.get(GregorianCalendar.YEAR));

        // -- дата конца --
        //берем завтрашнюю дату(+1 день)
        ...
        // выводим дату
        editEndDay.setText("" + nowCalendar.get(GregorianCalendar.DAY_OF_MONTH));
        editEndMonth.setText("" + (nowCalendar.get(GregorianCalendar.MONTH) + 1));
        editEndYear.setText("" + nowCalendar.get(GregorianCalendar.YEAR));
...
// -- кнопки согласия/отмены --
            ...
            public void onClick(View view) {
                if (isDateGood(editStartDay,
                    ...
                    try {
                        ...
                        ((CreateStatisticDialogInterface) getActivity()).createStatistic(
                        ...
                        Log.i(
                                "TeachersApp",
                                "CreatePeriodDialogFragment: you must implements CreateStatisticDialogInterface in your activity"
                        );
                    }
                    dismiss();
                }
        ...
        neutralButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    ((CreateStatisticDialogInterface) getActivity()).onlyUpdate();
                } catch (java.lang.ClassCastException e) {
                    //в вызвающей активности должен быть имплементирован класс CreateStatisticDialogInterface
                    e.printStackTrace();
                    Log.i(
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        Log.i("TeachersApp", "CreatePeriodDialogFragment - onCancel");
...
interface CreateStatisticDialogInterface {
    void createStatistic(String name, String startDate, String endDate);
